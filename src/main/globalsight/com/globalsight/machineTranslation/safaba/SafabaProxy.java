...
public class SafabaProxy extends AbstractTranslator implements MachineTranslator
{
            ...
            Locale targetLocale) throws MachineTranslationException
    {
        ...
        String host = (String) paramMap.get("safa_mt_host");
		String port = (String) paramMap.get("safa_mt_port");
		String companyName = (String) paramMap.get("safa_mt_company_name");
		String password = (String) paramMap.get("safa_mt_password");
		String client = (String) paramMap.get("safaba_client");
