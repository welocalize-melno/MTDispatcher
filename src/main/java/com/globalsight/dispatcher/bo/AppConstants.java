...
public interface AppConstants
{
    ...
    public final String JSONPN_DOMAIN = "domain";
    public final String JSONPN_SOURCE_LOCALE = "srcLocale";
    public final String JSONPN_TARGET_LOCALE = "trgLocale";
    ...
    //User types
    public final String USER_TYPE_ADMIN = "Administrator";
    public final String USER_TYPE_USER = "User";


    //global admin account
    public final String GADMIN_USER_NAME = "globalAdmin";
    public final String GADMIN_FULL_NAME = "Global Admin";
    public final String GADMIN_PASSWORD = "password";
    public final String GADMIN_EMAIL = "admin@domain.com";
    public final String GADMIN_DESCRIPTION = "Global Admin account";
