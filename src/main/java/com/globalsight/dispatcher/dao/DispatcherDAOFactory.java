...
public class DispatcherDAOFactory
{
    ...
    static DomainDAO domainDAO;
    
    public synchronized static MTProfilesDAO getMTPRofileDAO()
    {
    ...
    public synchronized static MTPLanguagesDAO getMTPLanguagesDAO()
    {
        if (mtpLangDAO == null)
        {
    ...
    public synchronized static DomainDAO getDomainDAO()
    {
    	if (domainDAO == null)
    	{
