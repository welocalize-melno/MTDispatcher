...
{
    protected static final Logger logger = Logger.getLogger(TranslateDAO.class);
	...
	public String saveTranslatedData (Translate translate) {
		Session session = null;
	  try{
	  	session = sessionfactory.openSession();
	  	session.save(translate);
	  	logger.info("Translation data has been saved successfully");
		}catch(Exception e){
			logger.info("Error while saving Translation: "+e.getMessage());
		}finally{
